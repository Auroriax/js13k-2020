        ...
        /*curve(t, e) {
            ...
            if (s.fill && s.fill !== K && t.length >= 3) {
                const e = J(function(t, e = 0) {
                    ...
                    const n = [];
                    if (3 === s) n.push(N(t[0]), N(t[1]), N(t[2]), N(t[2]));
                    else {
                        const s = [];
                        s.push(t[0], t[0]);
